...
# The program wasn't working because the division in idf() was integer only,
# meaning that it would return an integere instead of a float.
# This is fixed by adding #to_f to the end of one of the numbers during 
# division.
